...
var ModalForm = ({ onToggle }) => {
  ...
  const roleLayout = useEnterprise(ROLE_LAYOUT, async () => (await import("./ModalForm-HR2WUYMB.js")).ROLE_LAYOUT, {
  ...
  const initialValues = useEnterprise(FORM_INITIAL_VALUES, async () => (await import("./ModalForm-HR2WUYMB.js")).FORM_INITIAL_VALUES, {
...
var ListPageCE = () => {
  ...
  const CreateAction = useEnterprise(CreateActionCE, async () => (await import("./CreateActionEE-5RME4QGH.js")).CreateActionEE);
...
var ListPage = () => {
  const UsersListPage = useEnterprise(ListPageCE, async () => (
    ...
    (await import("./ListPage-DU4K6EZL.js")).UserListPageEE
  ));
  if (!UsersListPage) {
    return null;
  }
...
//# sourceMappingURL=chunk-WXGWOCYR.js.map
