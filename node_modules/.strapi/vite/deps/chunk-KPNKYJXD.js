import {
  ...
  StageColumn,
  getDisplayName
} from "./chunk-MZ2XLHCP.js";
import {
  buildValidParams as buildValidParams2
} from "./chunk-AK5CFNWL.js";
import {
  getStageColorByHex
} from "./chunk-Z2FFGZBI.js";
import {
  LimitsModal
} from "./chunk-NWUDDE3C.js";
import {
...
} from "./chunk-DNXJFXEY.js";
import {
  useTypedSelector
} from "./chunk-6PXTFLYN.js";
import {
  ...
  useGetLocalesQuery
} from "./chunk-2IEFWO6I.js";
import {
  ReleaseActionMenu,
  ReleaseActionOptions
} from "./chunk-66OHL7WN.js";
import {
  index
} from "./chunk-UM5AONGQ.js";
import {
...
import {
  useDocumentActions
} from "./chunk-NNWIC44O.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-HOI3T5MV.js";
import {
  renderAdmin
...
function __variableDynamicImportRuntime1__(path) {
  switch (path) {
    case "./translations/ar.json":
      return import("./ar.json-QXUXADPG.js");
    case "./translations/cs.json":
      return import("./cs.json-BQNTDKKY.js");
    case "./translations/de.json":
      return import("./de.json-KEECYHOB.js");
    case "./translations/dk.json":
      return import("./dk.json-UJTKO3EV.js");
    case "./translations/en.json":
      return import("./en.json-EASBX66Z.js");
    case "./translations/es.json":
      return import("./es.json-2T2O3SSL.js");
    case "./translations/fr.json":
      return import("./fr.json-27AWG6G6.js");
    case "./translations/id.json":
      return import("./id.json-V5HIUFWU.js");
    case "./translations/it.json":
      return import("./it.json-L2CPFCJN.js");
    case "./translations/ja.json":
      return import("./ja.json-XJYY2XO2.js");
    case "./translations/ko.json":
      return import("./ko.json-MMDBOXCX.js");
    case "./translations/ms.json":
      return import("./ms.json-3V6DGQXB.js");
    case "./translations/nl.json":
      return import("./nl.json-E7UJP6OC.js");
    case "./translations/pl.json":
      return import("./pl.json-UWBSN5F2.js");
    case "./translations/pt-BR.json":
      return import("./pt-BR.json-AMN7KGWS.js");
    case "./translations/pt.json":
      return import("./pt.json-FNJZZIFG.js");
    case "./translations/ru.json":
      return import("./ru.json-AT25KYAL.js");
    case "./translations/sk.json":
      return import("./sk.json-LVGGMCBO.js");
    case "./translations/sv.json":
      return import("./sv.json-DISXVXVO.js");
    case "./translations/th.json":
      return import("./th.json-7IFJVA6L.js");
    case "./translations/tr.json":
      return import("./tr.json-CHVAHV62.js");
    case "./translations/uk.json":
      return import("./uk.json-VH63ZQDK.js");
    case "./translations/zh-Hans.json":
      return import("./zh-Hans.json-JHDNHFJI.js");
    case "./translations/zh.json":
      return import("./zh.json-OAQCTJ2Z.js");
    default:
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-QAPISC63.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
...
function __variableDynamicImportRuntime1__2(path) {
  switch (path) {
    case "./translations/ar.json":
      return import("./ar.json-UFMX2KZD.js");
    case "./translations/cs.json":
      return import("./cs.json-BZPVFDMS.js");
    case "./translations/de.json":
      return import("./de.json-BXKPO4LW.js");
    case "./translations/dk.json":
      return import("./dk.json-KKKVYSFS.js");
    case "./translations/en.json":
      return import("./en.json-A6WTQGZJ.js");
    case "./translations/es.json":
      return import("./es.json-MR65F3IL.js");
    case "./translations/fr.json":
      return import("./fr.json-M62X4DLG.js");
    case "./translations/id.json":
      return import("./id.json-4PBPFJUW.js");
    case "./translations/it.json":
      return import("./it.json-47HXJ335.js");
    case "./translations/ja.json":
      return import("./ja.json-HJKUVIQ3.js");
    case "./translations/ko.json":
      return import("./ko.json-O46WEGDY.js");
    case "./translations/ms.json":
      return import("./ms.json-TH6PC2W3.js");
    case "./translations/nl.json":
      return import("./nl.json-BAMLVODS.js");
    case "./translations/pl.json":
      return import("./pl.json-JBYADS4S.js");
    case "./translations/pt-BR.json":
      return import("./pt-BR.json-RPKP3YTV.js");
    case "./translations/pt.json":
      return import("./pt.json-ZAGKUHDX.js");
    case "./translations/ru.json":
      return import("./ru.json-YHSURYJC.js");
    case "./translations/sk.json":
      return import("./sk.json-BHFPLW5E.js");
    case "./translations/th.json":
      return import("./th.json-VFGVB36F.js");
    case "./translations/tr.json":
      return import("./tr.json-O7CRRBKF.js");
    case "./translations/uk.json":
      return import("./uk.json-IOE4JIWU.js");
    case "./translations/vi.json":
      return import("./vi.json-JJ3IA53S.js");
    case "./translations/zh-Hans.json":
      return import("./zh-Hans.json-JUJAYG4D.js");
    case "./translations/zh.json":
      return import("./zh.json-ULTFL2LB.js");
    default:
      return new Promise(function(resolve, reject) {
        (typeof queueMicrotask === "function" ? queueMicrotask : setTimeout)(
          reject.bind(null, new Error("Unknown variable dynamic import: " + path))
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-NTCBKRCN.js").then((mod) => ({
    ...
    children: [
      (0, import_jsx_runtime.jsx)(Popover.Trigger, {
        children: (0, import_jsx_runtime.jsx)(Button, {
          variant: "tertiary",
          startIcon: (0, import_jsx_runtime.jsx)(ForwardRef$1I, {}),
          size: "S",
  ...
  return (0, import_jsx_runtime4.jsx)("li", {
    children: (0, import_jsx_runtime4.jsxs)(ActionLinkWrapper, {
      ...
      children: [
        ...
        (0, import_jsx_runtime4.jsx)(ForwardRef$2k, {
          "aria-hidden": true
        })
      ]
    })
  ...
  return (0, import_jsx_runtime4.jsx)("li", {
    children: (0, import_jsx_runtime4.jsxs)(ActionLinkWrapper, {
      ...
      children: [
        ...
        (0, import_jsx_runtime4.jsx)(ForwardRef$2j, {
          "aria-hidden": true
        })
      ]
    })
...
var SearchAsset = ({ onChangeSearch, queryValue = null }) => {
  ...
  return (0, import_jsx_runtime5.jsx)(IconButton, {
    ...
    children: (0, import_jsx_runtime5.jsx)(ForwardRef$v, {})
  });
};
              ...
              children: [
                (0, import_jsx_runtime6.jsx)(ActionContainer, {
                  ...
                  children: (0, import_jsx_runtime6.jsx)(IconButton, {
                    ...
                    children: isGridView ? (0, import_jsx_runtime6.jsx)(ForwardRef$1e, {}) : (0, import_jsx_runtime6.jsx)(ForwardRef$1C, {})
                  })
                }),
      ...
      assetCount === 0 && folderCount === 0 && (0, import_jsx_runtime6.jsx)(Box, {
        ...
        children: (0, import_jsx_runtime6.jsx)(EmptyAssets, {
          ...
          action: canCreate && !isFiltering && !isSearching && (0, import_jsx_runtime6.jsx)(Button, {
            variant: "secondary",
            startIcon: (0, import_jsx_runtime6.jsx)(ForwardRef$G, {}),
            onClick: onAddAsset,
            children: formatMessage({
              ...
              return (0, import_jsx_runtime6.jsx)(Grid.Item, {
                ...
                children: (0, import_jsx_runtime6.jsx)(FolderCard, {
                  ...
                  cardActions: onEditFolder && (0, import_jsx_runtime6.jsx)(IconButton, {
                    ...
                    children: (0, import_jsx_runtime6.jsx)(ForwardRef$N, {})
                  }),
...
var CarouselAsset = ({ asset }) => {
  ...
  return (0, import_jsx_runtime11.jsx)(DocAsset, {
    ...
    justifyContent: "center",
    hasRadius: true,
    children: ((_d = asset.ext) == null ? void 0 : _d.includes("pdf")) ? (0, import_jsx_runtime11.jsx)(ForwardRef$1M, {
      "aria-label": asset.alternativeText || asset.name,
      width: "24px",
      height: "32px"
    }) : (0, import_jsx_runtime11.jsx)(ForwardRef$1P, {
      "aria-label": asset.alternativeText || asset.name,
      width: "24px",
      height: "32px"
    })
  ...
  return (0, import_jsx_runtime12.jsxs)(CarouselActions, {
    children: [
      onAddAsset && (0, import_jsx_runtime12.jsx)(IconButton, {
        ...
        children: (0, import_jsx_runtime12.jsx)(ForwardRef$G, {})
      }),
      ...
      onDeleteAsset && (0, import_jsx_runtime12.jsx)(IconButton, {
        ...
        children: (0, import_jsx_runtime12.jsx)(ForwardRef$b, {})
      }),
...
var EmptyStateAsset = ({ disabled = false, onClick, onDropAsset }) => {
  ...
  return (0, import_jsx_runtime13.jsxs)(Flex, {
    ...
    children: [
      (0, import_jsx_runtime13.jsx)(ForwardRef$F, {
        "aria-hidden": true,
        width: "3.2rem",
        height: "3.2rem",
...
function __variableDynamicImportRuntime2__(path) {
  switch (path) {
    case "./translations/ca.json":
      return import("./ca.json-IH3VBBSJ.js");
    case "./translations/de.json":
      return import("./de.json-GV3RJDE7.js");
    case "./translations/dk.json":
      return import("./dk.json-WT6G5VRK.js");
    case "./translations/en.json":
      return import("./en.json-EMMOUUWL.js");
    case "./translations/es.json":
      return import("./es.json-INMXLNR5.js");
    case "./translations/fr.json":
      return import("./fr.json-EKBMXIBH.js");
    case "./translations/he.json":
      return import("./he.json-EK2YZVOY.js");
    case "./translations/it.json":
      return import("./it.json-JWQDIVCU.js");
    case "./translations/ja.json":
      return import("./ja.json-54VCSXPL.js");
    case "./translations/ko.json":
      return import("./ko.json-FZUHQ6JQ.js");
    case "./translations/ms.json":
      return import("./ms.json-6LBUTHRU.js");
    case "./translations/pl.json":
      return import("./pl.json-VSZX2ZQA.js");
    case "./translations/pt-BR.json":
      return import("./pt-BR.json-5U5MIUTC.js");
    case "./translations/pt.json":
      return import("./pt.json-MXN2P7LV.js");
    case "./translations/ru.json":
      return import("./ru.json-BAAFSBVU.js");
    case "./translations/sk.json":
      return import("./sk.json-Q3U6VVBS.js");
    case "./translations/th.json":
      return import("./th.json-QUTVDO6A.js");
    case "./translations/tr.json":
      return import("./tr.json-ZDBSK23H.js");
    case "./translations/uk.json":
      return import("./uk.json-FXOPKQGW.js");
    case "./translations/zh-Hans.json":
      return import("./zh-Hans.json-AUD4YDDL.js");
    case "./translations/zh.json":
      return import("./zh.json-4MVHYPH7.js");
    default:
      return new Promise(function(resolve, reject) {
        (typeof queueMicrotask === "function" ? queueMicrotask : setTimeout)(
          reject.bind(null, new Error("Unknown variable dynamic import: " + path))
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-QXZ2D6JT.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-DZNQP2LR.js");
        return {
      ...
      (0, import_jsx_runtime16.jsxs)(Dialog.Content, {
        children: [
          ...
          (0, import_jsx_runtime16.jsx)(Dialog.Body, {
            icon: (0, import_jsx_runtime16.jsx)(ForwardRef$2, {}),
...
var EntryValidationText = ({ status = "draft", validationErrors, action }) => {
  ...
  if (validationErrors) {
    ...
    return (0, import_jsx_runtime17.jsxs)(Flex, {
      gap: 2,
      children: [
        (0, import_jsx_runtime17.jsx)(ForwardRef$25, {
          fill: "danger600"
        }),
  ...
  const getStatusMessage = () => {
    if (action === "bulk-publish") {
      if (status === "published") {
        return {
          icon: (0, import_jsx_runtime17.jsx)(ForwardRef$2n, {
            fill: "success600"
          }),
          text: formatMessage({
        ...
        return {
          icon: (0, import_jsx_runtime17.jsx)(ForwardRef$2E, {
            fill: "alternative600"
          }),
          text: formatMessage({
                  ...
                  children: [
                    ...
                    (0, import_jsx_runtime17.jsx)(Table.Cell, {
                      children: (0, import_jsx_runtime17.jsx)(IconButton, {
                        ...
                        variant: "ghost",
                        children: (0, import_jsx_runtime17.jsx)(ForwardRef$N, {})
                      })
                    })
                  ]
                }, index4);
  ...
  return {
    ...
    options: displayedLocales.map((locale) => {
      ...
      return {
        ...
        startIcon: !entryWithLocaleExists ? (0, import_jsx_runtime18.jsx)(ForwardRef$G, {}) : null
      };
    }),
...
var FillFromAnotherLocaleAction = ({ documentId, meta, model, collectionType }) => {
  ...
  return {
    type: "icon",
    icon: (0, import_jsx_runtime18.jsx)(ForwardRef$1Z, {}),
        ...
        children: [
          (0, import_jsx_runtime18.jsx)(Dialog.Body, {
            children: (0, import_jsx_runtime18.jsxs)(Flex, {
              ...
              gap: 3,
              children: [
                (0, import_jsx_runtime18.jsx)(ForwardRef$2, {
                  width: "24px",
                  height: "24px",
                  fill: "danger600"
                }),
...
var BulkLocaleAction = ({ document, documentId, model, collectionType, action }) => {
  ...
  return {
    ...
    icon: isBulkPublish ? (0, import_jsx_runtime18.jsx)(ForwardRef$1d, {}) : (0, import_jsx_runtime18.jsx)(ForwardRef$26, {}),
...
var StyledTrash = dt(ForwardRef$b)`
  path {
    fill: currentColor;
  }
`;
...
var addLabelActionToField = (field) => {
  ...
  const labelActionProps = {
    ...
    icon: isFieldLocalized ? (0, import_jsx_runtime21.jsx)(ForwardRef$1Z, {}) : null
  };
  return {
    ...field,
          ...
          children: (0, import_jsx_runtime22.jsxs)(Flex, {
            ...
            children: [
              ...
              (0, import_jsx_runtime22.jsx)(Flex, {
                children: (0, import_jsx_runtime22.jsx)(ForwardRef$2v, {
                  width: "1.2rem",
                  height: "1.2rem"
                })
              })
...
function __variableDynamicImportRuntime1__3(path) {
  switch (path) {
    case "./translations/de.json":
      return import("./de.json-CTOGRNKK.js");
    case "./translations/dk.json":
      return import("./dk.json-63UODPH2.js");
    case "./translations/en.json":
      return import("./en.json-35DVHPKU.js");
    case "./translations/es.json":
      return import("./es.json-KPWYXZKC.js");
    case "./translations/fr.json":
      return import("./fr.json-P3RLQTYM.js");
    case "./translations/ko.json":
      return import("./ko.json-XWMTVIG7.js");
    case "./translations/pl.json":
      return import("./pl.json-KRBJKFCJ.js");
    case "./translations/ru.json":
      return import("./ru.json-YTQEGKPP.js");
    case "./translations/tr.json":
      return import("./tr.json-CR5HFOEC.js");
    case "./translations/uk.json":
      return import("./uk.json-56Q7KMRH.js");
    case "./translations/zh-Hans.json":
      return import("./zh-Hans.json-5AY3HJUC.js");
    case "./translations/zh.json":
      return import("./zh.json-FKDHHFL2.js");
    default:
      return new Promise(function(resolve, reject) {
        (typeof queueMicrotask === "function" ? queueMicrotask : setTimeout)(
          reject.bind(null, new Error("Unknown variable dynamic import: " + path))
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-TSIBYCMM.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
...
var NoReleases = () => {
  ...
  return (0, import_jsx_runtime24.jsx)(EmptyStateLayout, {
    icon: (0, import_jsx_runtime24.jsx)(ForwardRef$m, {
      width: "16rem"
    }),
...
var ReleaseActionModalForm = ({ documentId, document, model, collectionType }) => {
  ...
  return {
    ...
    icon: (0, import_jsx_runtime24.jsx)(ForwardRef$Q, {}),
    ...
    children: [
      (0, import_jsx_runtime26.jsx)(Popover.Trigger, {
        children: (0, import_jsx_runtime26.jsx)(Button, {
          ...
          endIcon: releases.length > 0 ? (0, import_jsx_runtime26.jsx)(ForwardRef$2v, {
            width: "1.2rem",
            height: "1.2rem"
          }) : null,
...
function __variableDynamicImportRuntime4__(path) {
  switch (path) {
    case "./translations/en.json":
      return import("./en.json-W5A2TTEV.js");
    case "./translations/uk.json":
      return import("./uk.json-AM55STBX.js");
    default:
      return new Promise(function(resolve, reject) {
        (typeof queueMicrotask === "function" ? queueMicrotask : setTimeout)(
          reject.bind(null, new Error("Unknown variable dynamic import: " + path))
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-53OJO2Z7.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-K6UWVMCI.js");
          return {
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-XZK73EAG.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-YDCRBXWW.js");
          return {
...
function __variableDynamicImportRuntime3__(path) {
  switch (path) {
    case "./translations/en.json":
      return import("./en.json-CORN3NSG.js");
    case "./translations/uk.json":
      return import("./uk.json-KUAE77DM.js");
    default:
      return new Promise(function(resolve, reject) {
        (typeof queueMicrotask === "function" ? queueMicrotask : setTimeout)(
          reject.bind(null, new Error("Unknown variable dynamic import: " + path))
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-WM7EZKTG.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-5MMENSLU.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-UXTHJOPL.js");
          return {
...
//# sourceMappingURL=chunk-KPNKYJXD.js.map
