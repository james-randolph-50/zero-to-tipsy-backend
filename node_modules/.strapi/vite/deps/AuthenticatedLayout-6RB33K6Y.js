import {
  require_lt,
  require_valid
} from "./chunk-SOWN2PCJ.js";
import {
  PrivateRoute
} from "./chunk-UXY6E3AS.js";
import {
  getDisplayName,
  getInitials,
  hashAdminUserEmail
...
`;
var LinkImpl = ({ children, ...props }) => (0, import_jsx_runtime2.jsx)(MainNavLinkWrapper, {
  ...props,
  children
});
...
var IconImpl = ({ label, children }) => {
  ...
  return (0, import_jsx_runtime2.jsx)(AccessibleIcon, {
    label,
    children
  });
};
...
var MainNavIcons = ({ listLinks, mobileLinks, handleClickOnLink }) => {
  ...
  return listLinks.length > 0 ? listLinks.map((link) => {
    ...
    const badgeContentLock = (link == null ? void 0 : link.licenseOnly) ? (0, import_jsx_runtime3.jsx)(ForwardRef$1g, {
      fill: "primary600"
    }) : void 0;
    ...
    const LinkElement = () => (0, import_jsx_runtime3.jsxs)(NavLink2.Link, {
      to: link.to,
    ...
    return isDesktop || !isDesktop && linkMobile ? (0, import_jsx_runtime3.jsx)(Flex, {
      tag: "li",
      children: (0, import_jsx_runtime3.jsx)(GuidedTourTooltip, {
        to: link.to,
        children: isDesktop ? (0, import_jsx_runtime3.jsx)(NavLink2.Tooltip, {
          label: labelValue,
          children: (0, import_jsx_runtime3.jsx)(LinkElement, {})
        }) : (0, import_jsx_runtime3.jsx)(LinkElement, {})
      })
    }, link.to) : null;
  }) : null;
};
var IconContainer = dt(Box)`
  svg {
    display: block;
  }
`;
var MainNavBurgerMenuLinks = ({ listLinks, handleClickOnLink }) => {
  ...
  return listLinks.length > 0 ? listLinks.map((link) => {
    ...
    return (0, import_jsx_runtime3.jsx)(Flex, {
      ...
      alignItems: "center",
      tag: "li",
      children: (0, import_jsx_runtime3.jsxs)(NavLink2.Link, {
        to: navigationTarget,
  ...
  return (0, import_jsx_runtime4.jsx)(Box, {
    ...
    children: (0, import_jsx_runtime4.jsxs)(BrandIconWrapper, {
      ...
      children: [
        ...
        (0, import_jsx_runtime4.jsxs)(VisuallyHidden, {
          children: [
...
var NavUser = ({ initials, showDisplayName = false, children, ...props }) => {
  ...
  return (0, import_jsx_runtime5.jsx)(Flex, {
    ...
    children: (0, import_jsx_runtime5.jsxs)(Menu.Root, {
      children: [
        (0, import_jsx_runtime5.jsx)(MenuTrigger, {
          endIcon: null,
          fullWidth: true,
          ...
          children: (0, import_jsx_runtime5.jsxs)(Flex, {
            ...
            gap: 3,
            children: [
              (0, import_jsx_runtime5.jsx)(MenuIcon, {
                justifyContent: "center",
                children: (0, import_jsx_runtime5.jsx)(Avatar.Item, {
                  delayMs: 0,
                  fallback: initials || getInitials(user)
                })
              }),
              showDisplayName ? (0, import_jsx_runtime5.jsx)(Typography, {
                variant: "omega",
...
// node_modules/@strapi/admin/dist/admin/admin/src/components/MainNav/NavBurgerMenu.mjs
var NavBurgerMenuWrapper = dt(Box)`
  position: fixed;
...
`;
var NavBurgerMenu = ({ isShown, handleClickOnLink, listLinks }) => (0, import_jsx_runtime6.jsx)(NavBurgerMenuWrapper, {
  $isShown: isShown,
  children: (0, import_jsx_runtime6.jsx)(ScrollAreaImpl$1, {
    children: (0, import_jsx_runtime6.jsxs)(Box, {
      ...
      children: [
        (0, import_jsx_runtime6.jsx)(MainNavBurgerMenuLinks, {
          listLinks,
          handleClickOnLink
        }),
        (0, import_jsx_runtime6.jsx)(Box, {
          paddingTop: 4,
          tag: "li",
          children: (0, import_jsx_runtime6.jsx)(NavUser, {
...
var CircleProgressBar = ({ percentage }) => {
  ...
  return (0, import_jsx_runtime7.jsxs)("svg", {
    ...
    viewBox: "0 0 100 100",
    children: [
      (0, import_jsx_runtime7.jsx)("defs", {
        children: (0, import_jsx_runtime7.jsxs)("linearGradient", {
          id: "progressGradient",
          x1: "0%",
          y1: "0%",
          x2: "100%",
          y2: "0%",
          children: [
            (0, import_jsx_runtime7.jsx)("stop", {
              offset: "0%",
      ...
      (0, import_jsx_runtime7.jsx)("circle", {
        cx: "50",
        cy: "50",
        r: radius,
        stroke: "#ccc",
...
var TrialCountdown = () => {
  ...
  return (0, import_jsx_runtime7.jsx)(Container, {
    justifyContent: "center",
    padding: 3,
    children: (0, import_jsx_runtime7.jsx)(TooltipImpl, {
      ...
      children: (0, import_jsx_runtime7.jsx)("div", {
        ...
        children: (0, import_jsx_runtime7.jsx)(CircleProgressBar, {
...
var LeftMenu = ({ generalSectionLinks, pluginsSectionLinks, topMobileNavigation, burgerMobileNavigation }) => {
  ...
  return (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, {
    children: [
      (0, import_jsx_runtime8.jsxs)(MainNav, {
        children: [
          (0, import_jsx_runtime8.jsx)(NavBrand, {}),
          (0, import_jsx_runtime8.jsx)(Divider, {}),
          (0, import_jsx_runtime8.jsxs)(MenuDetails, {
            children: [
              (0, import_jsx_runtime8.jsx)(NavListWrapper, {
                tag: "ul",
                gap: 3,
                direction: {
                  initial: "row",
                ...
                paddingTop: 3,
                paddingBottom: 3,
                children: (0, import_jsx_runtime8.jsx)(MainNavIcons, {
                  listLinks,
                  mobileLinks: topMobileNavigationLinks,
                  handleClickOnLink
                })
              }),
              (0, import_jsx_runtime8.jsx)(TrialCountdown, {}),
              (0, import_jsx_runtime8.jsx)(Box, {
                ...
                padding: 3,
                children: (0, import_jsx_runtime8.jsx)(NavUser, {})
              })
            ]
          }),
          (0, import_jsx_runtime8.jsx)(Box, {
            ...
            children: (0, import_jsx_runtime8.jsx)(Flex, {
              ...
              children: !isBurgerMenuShown ? (0, import_jsx_runtime8.jsx)(ForwardRef$1e, {}) : (0, import_jsx_runtime8.jsx)(ForwardRef$26, {})
            })
          })
        ]
      }),
      (0, import_jsx_runtime8.jsx)(NavBurgerMenu, {
...
var PluginsInitializer = ({ children }) => {
  ...
  const [{ plugins }, dispatch] = React2.useReducer(reducer, initialState, () => init(appPlugins));
  const setPlugin = React2.useRef((pluginId) => {
    dispatch({
  ...
  if (hasApluginNotReady) {
    const initializers = Object.keys(plugins).reduce((acc, current) => {
      ...
      if (InitializerComponent) {
        ...
        acc.push((0, import_jsx_runtime9.jsx)(InitializerComponent, {
    ...
    return (0, import_jsx_runtime9.jsxs)(import_jsx_runtime9.Fragment, {
      children: [
        initializers,
        (0, import_jsx_runtime9.jsx)(Page.Loading, {})
      ]
    });
  }
  return children;
...
var Banner = ({ isTrialEndedRecently }) => {
  const { formatMessage } = useIntl();
  return (0, import_jsx_runtime10.jsx)(BannerBackground, {
    width: "100%",
    justifyContent: "center",
    children: (0, import_jsx_runtime10.jsxs)(Flex, {
      ...
      gap: 2,
      children: [
        (0, import_jsx_runtime10.jsxs)(Box, {
          children: [
        ...
        (0, import_jsx_runtime10.jsx)(Box, {
          children: (0, import_jsx_runtime10.jsx)(LinkButton, {
            width: "max-content",
            variant: "tertiary",
...
var UpsellBanner = () => {
  ...
  if (((_b = timeLeftData.data) == null ? void 0 : _b.trialEndsAt) || isTrialEndedRecently) {
    return (0, import_jsx_runtime10.jsx)(Banner, {
...
var useMenu = (shouldUpdateStrapi) => {
  ...
  const [menuWithUserPermissions, setMenuWithUserPermissions] = React3.useState({
    generalSectionLinks: [
      {
        icon: ForwardRef$1q,
        intlLabel: {
  ...
  const generalSectionLinksRef = React3.useRef(menuWithUserPermissions.generalSectionLinks);
  React3.useEffect(() => {
...
var AdminLayout = () => {
  ...
  const [userId, setUserId] = React4.useState();
  ...
  const [tagName, setTagName] = React4.useState(strapiVersion);
  React4.useEffect(() => {
  ...
  return (0, import_jsx_runtime11.jsxs)(AppInfoProvider, {
    ...appInfo,
    userId,
    latestStrapiReleaseTag: tagName,
    shouldUpdateStrapi: checkLatestStrapiVersion(strapiVersion, tagName),
    children: [
      (0, import_jsx_runtime11.jsx)(NpsSurvey, {}),
      (0, import_jsx_runtime11.jsx)(PluginsInitializer, {
        children: (0, import_jsx_runtime11.jsx)(DndProvider, {
          backend: HTML5Backend,
          children: (0, import_jsx_runtime11.jsxs)(Box, {
            background: "neutral100",
            children: [
              (0, import_jsx_runtime11.jsx)(SkipToContent, {
                children: formatMessage({
                  id: "skipToContent",
              ...
              (0, import_jsx_runtime11.jsxs)(Flex, {
                ...
                alignItems: "flex-start",
                children: [
                  (0, import_jsx_runtime11.jsx)(LeftMenu, {
                    generalSectionLinks,
                    pluginsSectionLinks,
                    topMobileNavigation,
                    burgerMobileNavigation
                  }),
                  (0, import_jsx_runtime11.jsxs)(Box, {
                    flex: 1,
                    overflow: "auto",
                    width: "100%",
                    height: {
                    ...
                    children: [
                      (0, import_jsx_runtime11.jsx)(UpsellBanner, {}),
                      (0, import_jsx_runtime11.jsx)(Outlet, {})
                    ]
                  })
                ]
              })
...
var PrivateAdminLayout = () => {
  return (0, import_jsx_runtime11.jsx)(PrivateRoute, {
    children: (0, import_jsx_runtime11.jsx)(AdminLayout, {})
  });
};
...
//# sourceMappingURL=AuthenticatedLayout-6RB33K6Y.js.map
