import {
  reducer
} from "./chunk-FFLV5Y6T.js";
import {
  DEFAULT_BULK_ACTIONS,
  DEFAULT_TABLE_ROW_ACTIONS
} from "./chunk-OJTEQATX.js";
import {
  ActionsPanel,
  DEFAULT_ACTIONS,
...
var HistoryAction = ({ model, document }) => {
  ...
  return {
    icon: (0, import_jsx_runtime.jsx)(ForwardRef$2g, {}),
    label: formatMessage({
...
function __variableDynamicImportRuntime4__(path) {
  switch (path) {
    case "./translations/ar.json":
      return import("./ar.json-2RYT4GOR.js");
    case "./translations/ca.json":
      return import("./ca.json-MAKLGYBO.js");
    case "./translations/cs.json":
      return import("./cs.json-IOT3V3MR.js");
    case "./translations/de.json":
      return import("./de.json-HESFHHD5.js");
    case "./translations/en.json":
      return import("./en.json-RHB45JUU.js");
    case "./translations/es.json":
      return import("./es.json-S4YGZUO5.js");
    case "./translations/eu.json":
      return import("./eu.json-PEL5INU6.js");
    case "./translations/fr.json":
      return import("./fr.json-5V5HIDXR.js");
    case "./translations/gu.json":
      return import("./gu.json-ONLF7EJO.js");
    case "./translations/hi.json":
      return import("./hi.json-TSN4ZXKI.js");
    case "./translations/hu.json":
      return import("./hu.json-F52FRMO2.js");
    case "./translations/id.json":
      return import("./id.json-NKP57HGX.js");
    case "./translations/it.json":
      return import("./it.json-N7RDZBKW.js");
    case "./translations/ja.json":
      return import("./ja.json-OUVA2XJO.js");
    case "./translations/ko.json":
      return import("./ko.json-K6MYKJPU.js");
    case "./translations/ml.json":
      return import("./ml.json-6JOW5P5W.js");
    case "./translations/ms.json":
      return import("./ms.json-KWFOS2QR.js");
    case "./translations/nl.json":
      return import("./nl.json-VO34HFDJ.js");
    case "./translations/pl.json":
      return import("./pl.json-SYHRN4MS.js");
    case "./translations/pt-BR.json":
      return import("./pt-BR.json-QC67ZSY3.js");
    case "./translations/pt.json":
      return import("./pt.json-WOQ22FDW.js");
    case "./translations/ru.json":
      return import("./ru.json-TFNR66WH.js");
    case "./translations/sa.json":
      return import("./sa.json-BLQXR7F5.js");
    case "./translations/sk.json":
      return import("./sk.json-XMLMNOXC.js");
    case "./translations/sv.json":
      return import("./sv.json-GHOCOJ7J.js");
    case "./translations/th.json":
      return import("./th.json-GLDTD24O.js");
    case "./translations/tr.json":
      return import("./tr.json-QMK7TCQO.js");
    case "./translations/uk.json":
      return import("./uk.json-LUS75ZRS.js");
    case "./translations/vi.json":
      return import("./vi.json-WWNZEJIL.js");
    case "./translations/zh-Hans.json":
      return import("./zh-Hans.json-WU76NS6Q.js");
    case "./translations/zh.json":
      return import("./zh.json-2X5OZBG3.js");
    default:
...
var index = {
  register(app) {
    ...
    app.router.addRoute({
      ...
      lazy: async () => {
        const { Layout } = await import("./layout-BMVJZUHM.js");
        return {
          Component: Layout
        };
      },
    ...
    app.widgets.register((widgets) => {
      const lastEditedWidget = {
        ...
        component: async () => {
          const { LastEditedWidget } = await import("./Widgets-VXYB4NQZ.js");
      ...
      const lastPublishedWidget = {
        ...
        component: async () => {
          const { LastPublishedWidget } = await import("./Widgets-VXYB4NQZ.js");
      ...
      const entriesWidget = {
        ...
        component: async () => {
          const { ChartEntriesWidget } = await import("./Widgets-VXYB4NQZ.js");
...
//# sourceMappingURL=chunk-UM5AONGQ.js.map
