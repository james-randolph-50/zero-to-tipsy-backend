...
function __variableDynamicImportRuntime1__(path) {
  switch (path) {
    case "./translations/en.json":
      return import("./en.json-GSILOYDO.js");
    case "./translations/es.json":
      return import("./es.json-W7BYXY6E.js");
    case "./translations/fr.json":
      return import("./fr.json-A63TLDPY.js");
    case "./translations/it.json":
      return import("./it.json-HFLFW3V5.js");
    case "./translations/ru.json":
      return import("./ru.json-GGEUSJBQ.js");
    case "./translations/uk.json":
      return import("./uk.json-CDFI4DLC.js");
    default:
  ...
  register(app) {
    ...
    if (backendURL == null ? void 0 : backendURL.includes("localhost")) {
      app.addMenuLink({
        ...
        Component: async () => {
          const { App } = await import("./App-LZQDIMCG.js");
          return App;
        }
      });
      const plugin = {
