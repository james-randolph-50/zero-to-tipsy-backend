...
import {
  useClipboard
} from "./chunk-LCNQEMBU.js";
import {
  useEnterprise
} from "./chunk-BPMOFKMZ.js";
import {
  ADMIN_PERMISSIONS_EE,
  AUDIT_LOGS_DEFAULT_PAGE_SIZE,
  getEERoutes
} from "./chunk-4KHECAXT.js";
import {
  Login
} from "./chunk-FZZI27L5.js";
import {
  MemoizedInputRenderer
} from "./chunk-ZU65REEY.js";
import {
  Form
} from "./chunk-HDNHFK2L.js";
import {
  Column,
  LayoutContent,
  Logo,
  UnauthenticatedLayout
} from "./chunk-VTWSYG64.js";
import {
  ConfigurationProvider
} from "./chunk-LA4V6DN7.js";
import {
  require_baseMerge,
...
import {
  require_baseRest
} from "./chunk-U7R3S4N2.js";
import {
  HistoryProvider
} from "./chunk-KAIIASL3.js";
import {
  errorsTrads
              ...
              children: (0, import_jsx_runtime3.jsx)(Theme, {
                ...
                children: (0, import_jsx_runtime3.jsx)(NotificationsProvider, {
                  children: (0, import_jsx_runtime3.jsx)(TrackingProvider, {
                    children: (0, import_jsx_runtime3.jsx)(GuidedTourContext, {
        ...
        children: (0, import_jsx_runtime5.jsxs)(Flex, {
          ...
          children: [
            (0, import_jsx_runtime5.jsxs)(Flex, {
              ...
              gap: 2,
              children: [
                (0, import_jsx_runtime5.jsx)(ForwardRef$2, {
                  width: "32px",
                  height: "32px",
                  fill: "danger600"
                }),
            ...
            (0, import_jsx_runtime5.jsxs)(Flex, {
              ...
              children: [
                ...
                (0, import_jsx_runtime5.jsx)(Button, {
                  onClick: handleClick,
                  variant: "tertiary",
                  startIcon: (0, import_jsx_runtime5.jsx)(ForwardRef$1_, {}),
                  children: formatMessage({
                    id: "app.error.copy",
      ...
      (0, import_jsx_runtime6.jsx)(Layouts.Content, {
        children: (0, import_jsx_runtime6.jsx)(EmptyStateLayout, {
          action: (0, import_jsx_runtime6.jsx)(LinkButton, {
            tag: Link,
            variant: "secondary",
            endIcon: (0, import_jsx_runtime6.jsx)(ForwardRef$2G, {}),
            to: "/",
            children: formatMessage({
          ...
          hasRadius: true,
          icon: (0, import_jsx_runtime6.jsx)(ForwardRef$k, {
            width: "16rem"
          }),
          shadow: "tableShadow"
        })
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-KDBIUAL3.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-LYH2CTWH.js");
        return {
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-SLWY7573.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-IIM64THJ.js")).FORMS, {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-AIDQ6VIU.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-W72MWXRR.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-TRD7VZXC.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-OSABBZQU.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-MIK3BVOT.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-MFJ5IWSX.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-547YAC4G.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-RGEP6UYK.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-E2R4TGP2.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-NDBLCTFS.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-VAC26THQ.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-R2VXMUST.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-CBUNTB24.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-XC4Q6LBM.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-LGR2H663.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-PB5ZAWP7.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-D2NC6FOT.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-GSVLMBDF.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-VJGCLPGG.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-DHZMTAYH.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-GDVCUIB3.js");
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import("./MarketplacePage-QDLVH4A6.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-PGXPL4QX.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-SHXKNIQ2.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-RQTOHKMS.js");
              return {
...
function __variableDynamicImportRuntime3__(path) {
  switch (path) {
    case "./translations/en-GB.js":
      return import("./en-GB-HDJXPP4S.js");
    default:
      return new Promise(function(resolve, reject) {
        (typeof queueMicrotask === "function" ? queueMicrotask : setTimeout)(
          reject.bind(null, new Error("Unknown variable dynamic import: " + path))
    ...
    this.widgets.register([
      {
        ...
        component: async () => {
          const { ProfileWidget } = await import("./Widgets-C32TGUZ3.js");
      ...
      },
      {
        ...
        component: async () => {
          const { KeyStatisticsWidget } = await import("./Widgets-C32TGUZ3.js");
      ...
      this.widgets.register([
        {
          ...
          component: async () => {
            const { AuditLogsWidget } = await import("./Widgets-35WUWCGK.js");
...
//# sourceMappingURL=chunk-YH7SJQYP.js.map
