...
import {
  LimitsModal
} from "./chunk-MNBSVH7M.js";
import {
  useTypedSelector
} from "./chunk-S6QOD6HJ.js";
import {
  AssigneeColumn,
  StageColumn,
  getDisplayName
} from "./chunk-YXNU6NQW.js";
import {
  getStageColorByHex
} from "./chunk-SKALYZIY.js";
import {
...
import {
  ...
  useGetLocalesQuery
} from "./chunk-SEBKLMK4.js";
import {
  ReleaseActionMenu,
  ReleaseActionOptions
} from "./chunk-6PJJHJQX.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-XI4R4KDJ.js";
import {
  useConfig
} from "./chunk-6GMGFACV.js";
import {
  AssetSource,
  AssetType,
...
import {
  useDocumentActions
} from "./chunk-PNZVMUUY.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-ATGMN5D4.js";
import {
  renderAdmin
} from "./chunk-YH7SJQYP.js";
import {
  useLicenseLimits
} from "./chunk-O6IAMXXB.js";
import {
  Table,
  useTable
} from "./chunk-BN2JPEWP.js";
import {
  useField,
  useForm
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-VIJHNX4X.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-ZOW4TRMB.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-B5VSI5TW.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-RM7IEQCA.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-YKBBUQ5F.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-ZEUNJ4N6.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-D2FHY3BK.js");
          return {
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-YSVEXPBP.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-AUX6DVFX.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-S2V4FKZ5.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-5OBNXAHP.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-NWXNIQTC.js");
          return {
...
//# sourceMappingURL=chunk-IAP253D7.js.map
